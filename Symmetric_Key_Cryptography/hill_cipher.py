...
def encrypt(msg: str) -> str:
    ...
    C = make_key()
    # Append zero if the messsage isn't divisible by 2
...
def find_multiplicative_inverse(determinant: int) -> int:
...
def make_key():
    ...
    while True:
        ...
        if inverse_element == -1:
            print(
                "Determinant is not relatively prime to 26, uninvertible key"
                )
...
def create_matrix_of_integers_from_string(string: str):
