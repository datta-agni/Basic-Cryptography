...
class Diffie_Hellman(object):
    ...
    def genKey(self, otherKey):
        ...
        # Convert the shared secret (int) to an array of bytes in network order otherwise hashlib can't hash it.
        try:
    ...
    def showParams(self):
        ...
        print(
            "Public key[{0}]: {1}".format(self.publicKey.bit_length(), self.publicKey)
        )
